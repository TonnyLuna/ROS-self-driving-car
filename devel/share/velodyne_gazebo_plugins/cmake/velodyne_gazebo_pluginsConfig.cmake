...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_gazebo_plugins_SOURCE_PREFIX /home/tonny/catvehicle_ws/src/velodyne_simulator/velodyne_gazebo_plugins)
  set(velodyne_gazebo_plugins_DEVEL_PREFIX /home/tonny/catvehicle_ws/devel)
  ...
  set(velodyne_gazebo_plugins_INSTALL_PREFIX /home/tonny/catvehicle_ws/install)
...
if(NOT "/home/tonny/catvehicle_ws/src/velodyne_simulator/velodyne_gazebo_plugins/include " STREQUAL " ")
  set(velodyne_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/tonny/catvehicle_ws/src/velodyne_simulator/velodyne_gazebo_plugins/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'velodyne_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Kevin Hallenbeck <khallenbeck@dataspeedinc.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'velodyne_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tonny/catvehicle_ws/src/velodyne_simulator/velodyne_gazebo_plugins/${idir}'.  Ask the maintainer 'Kevin Hallenbeck <khallenbeck@dataspeedinc.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tonny/catvehicle_ws/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${velodyne_gazebo_plugins_dep}_FOUND)
      find_package(${velodyne_gazebo_plugins_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${velodyne_gazebo_plugins_dep} REQUIRED ${depend_list})
  endif()
