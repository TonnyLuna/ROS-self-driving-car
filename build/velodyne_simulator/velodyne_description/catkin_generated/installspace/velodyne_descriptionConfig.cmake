...
if("FALSE" STREQUAL "TRUE")
  set(velodyne_description_SOURCE_PREFIX /home/tonny/catvehicle_ws/src/velodyne_simulator/velodyne_description)
  set(velodyne_description_DEVEL_PREFIX /home/tonny/catvehicle_ws/devel)
  ...
  set(velodyne_description_INSTALL_PREFIX /home/tonny/catvehicle_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'velodyne_description' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Kevin Hallenbeck <khallenbeck@dataspeedinc.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'velodyne_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tonny/catvehicle_ws/install/${idir}'.  Ask the maintainer 'Kevin Hallenbeck <khallenbeck@dataspeedinc.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${velodyne_description_dep}_FOUND)
      find_package(${velodyne_description_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${velodyne_description_dep} REQUIRED ${depend_list})
  endif()
